...
<template>
  ...
  <div>
    ...
    <van-panel title="寄送信息">
      <van-field :value="username" label="物流单号" placeholder="请输入物流单号" clearable required />
    </van-panel>
    <mybr />
    <div class="confirmsignbtn">
      <van-button square size="normal" type="info" @click="onConfirmCocOut">提交出库</van-button>
    </div>
    <!--
