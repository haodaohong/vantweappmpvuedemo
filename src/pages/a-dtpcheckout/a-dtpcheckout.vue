  ...
  <div>  
    <van-panel title="基本信息">
      ...
      -->
        ...
        <van-popup :show="isshowdatetimepicker"
                  position="bottom">
...
客服电话：40088888888<br/><br/><br/><br/></div>
 <mybr/>
    </van-panel>
     <mybr/>
    <div class="confirmsignbtn">
       <van-button round size="normal" type="info" @click="onConfirmSign">同意并确认提交</van-button>
    </div>
     <mybr/>
    <!--
